...
with tf.Session() as sess:
    ...
    # acc1 = sess.run(accuracy,feed_dict={x:mnist.test.images,y:mnist.test.labels,keep_prob:1.0})
    saver.restore(sess,"net/my_net.ckpt")
    acc2 = sess.run(accuracy,feed_dict={x:mnist.test.images,y:mnist.test.labels,keep_prob:1.0})
    print("acc1:",acc2," acc2:",acc2)